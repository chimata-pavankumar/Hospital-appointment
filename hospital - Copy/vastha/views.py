...
"""def main(request):
    tab = treatmen.objects.all()
    t = treatmen()
    t.date = 'oct.21,2019'
    t.doctor = 'Dr.vishwa'
    t.price = 599
    t.treatments = 'cardiology'

    t1 = treatmen()
    t1.date = 'oct.22,2019'
    t1.doctor = 'Dr.vishnu'
    t1.price = 799
    t1.treatments = 'dermology'
    tt = [t,t1]
    return render(request, 'main.html', {'t':t})
    'doctor':doctor, 'treatments':treatments,'appointment':appointment,'dates':dates,'price':price, 'doctor2':doctor2, 'treatments2':treatments2,'appointment2':appointment2,'dates2':dates2,'price2':price2,'doctor3':doctor3, 'treatments3':treatments3,'appointment3':appointment3,'dates3':dates3,'price3':price3,'doctor4':doctor4, 'treatments4':treatments4,'appointment4':appointment4,'dates4':dates4,'price4':price4,'doctor5':doctor5, 'treatments5':treatments5,'appointment5':appointment5,'dates5':dates5,'price5':price5,'doctor6':doctor6, 'treatments6':treatments6,'appointment6':appointment6,'dates6':dates6,'price6':price6,'doctor7':doctor7, 'treatments7':treatments7,'appointment7':appointment7,'dates7':dates7,'price7':price7,'doctor8':doctor8, 'treatments8':treatments8,'appointment8':appointment8,'dates8':dates8,'price8':price8})
"""